...
PATTERNS: list[SecretPattern] = [
    ...
    SecretPattern(
        ...
        severity="warning",
        pattern=r'(?:mongodb(?:\+srv)?|postgres(?:ql)?|mysql|mariadb|redis|amqp|ftp|smtp)://[^\s\'"]{10,}',
        description="Database or service connection string URI.",
        case_insensitive=True,
    ),
    ...
    SecretPattern(
        ...
        severity="error",
        pattern=r'(?:OPENAI_API_KEY|openai_api_key)\s*[:=]\s*["\']?sk-[A-Za-z0-9_-]{20,}["\']?',
